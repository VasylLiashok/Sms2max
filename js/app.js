(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".sms-portal__slider")) new core(".sms-portal__slider", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".article-blog__slider")) new core(".article-blog__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                allowTouchMove: true,
                navigation: {
                    prevEl: ".article-blog__slider .swiper-button-prev",
                    nextEl: ".article-blog__slider .swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.1,
